...
public class PlayStatisticActivity extends AppCompatActivity {
...
// No Titlebar
    ...
    private void initChart(){
        ...
        for(int i = 0;i < 7;i++){
            ...
            long count = appInfoHelper.getTotalPlayTime(appInfos);
        ...
        LineChartHelper chart = new LineChartHelper((LineChart) findViewById(R.id.chart),totalTime, Color.rgb(255,99,71));
    }

    @Override
    public void onBackPressed() {
        startActivity(new Intent(this,WorkStatisticActivity.class));
        finish();
        // super.onBackPressed();
    }
    /**
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (x_temp01 != 0 && y_temp01 != 0)//
                {
                    ...
                    {
                        startActivity(new Intent(PlayStatisticActivity.this, OtherStatisticActivity.class));
                        finish();
                    }
                ...
                {
                    startActivity(new Intent(PlayStatisticActivity.this, WorkStatisticActivity.class));
                    finish();
                }
                break;
            }
