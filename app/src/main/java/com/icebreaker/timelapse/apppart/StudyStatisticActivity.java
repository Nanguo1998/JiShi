...
// No Titlebar
    ...
    private void initChart(){
        ...
        for(int i = 0;i < 7;i++){
            ...
            long count = appInfoHelper.getTotalStudyTime(appInfos);
        ...
        LineChartHelper chart = new LineChartHelper((LineChart) findViewById(R.id.chart),totalTime, Color.rgb(0,255,127));
    }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (x_temp01 != 0 && y_temp01 != 0)//
                {
                    ...
                    {
                        startActivity(new Intent(StudyStatisticActivity.this, WorkStatisticActivity.class));
                        finish();
                    }
                ...
                {
                    startActivity(new Intent(StudyStatisticActivity.this, AnalyseActivity.class));
                    finish();
                }
                break;
            }
