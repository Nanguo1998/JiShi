...
public class WorkStatisticActivity extends AppCompatActivity {
...
// No Titlebar
    ...
    private void initChart(){
        ...
        for(int i = 0;i < 7;i++){
            ...
            long count = appInfoHelper.getTotalWorkTime(appInfos);
        ...
        LineChartHelper chart = new LineChartHelper((LineChart) findViewById(R.id.chart),totalTime, Color.rgb(100,149,237));
    }

    @Override
    public void onBackPressed() {
        startActivity(new Intent(this,StudyStatisticActivity.class));
        finish();
        // super.onBackPressed();
    }
    /**
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (x_temp01 != 0 && y_temp01 != 0)//
                {
                    ...
                    {
                        startActivity(new Intent(WorkStatisticActivity.this, PlayStatisticActivity.class));
                        finish();
                    }
                ...
                {
                    startActivity(new Intent(WorkStatisticActivity.this, StudyStatisticActivity.class));
                    finish();
                }
                break;
            }
